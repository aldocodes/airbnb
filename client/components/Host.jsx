    ...
    return (
      <div className={styles.hostInfo}>
        <div>
          ...
          <h1 className={styles.name}>Hosted by {this.state.name}</h1>
            <div class="header">
            </div>
            <div class="locationAndJoinDate">
              <li className={styles.location}>{this.state.location}</li>
              <li className={styles.join_date}><span aria-hidden="true"> · </span>{this.state.join_date}</li>
            ...
            <div class="reviewsAndReferences">
              ...
              <li className={styles.references}>
                <human class="fas fa-male" /> {this.state.references}
              </li>
            </div>
          </div>
          <img class="picture" src={this.state.picture} height="64" width="64"/>

          <div class="description">
            <li className={styles.description}>{this.state.description}</li>
          </div>

          <div class="languagesResponseRateTime">
            <div class="languages">
              <li className={styles.languages_word}>
                Languages: {this.state.languages_word}
              </li>
              <li className={styles.languages}>{this.state.languages}</li>
            </div>
            <div class="responseRate">
              <li className={styles.response_rate_word}>
                Response rate: {this.state.response_rate_word}
              </li>
